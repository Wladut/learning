...
//boundary search tree useful skill
...
public class SearchTree implements NodeList {
        ...
        while(currentItem != null) {
            ...
            if(comparision < 0){
                ...
                if(currentItem.next() != null){
                    ...
                    // there is no nede to the right, so add at this point
    ...
    public boolean removeItem(ListItem item) {
        // there is an algorithm for that for boundary tree
        if(item != null){
    ...
    public void traverse(ListItem root) {
        // recursive method (recall same method)
        if (root != null) {
